...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../zlib1.2.8/lib/ -lzdll
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../zlib1.2.8/lib/ -lzdll

INCLUDEPATH += $$PWD/../zlib1.2.8/include
DEPENDPATH += $$PWD/../zlib1.2.8/include
